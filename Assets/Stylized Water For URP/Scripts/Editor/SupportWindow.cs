...
namespace StylizedWaterForURP
{
    ...
    public class SupportWindow : EditorWindow
    {
        ...
        private void CheckUnityVersion()
        {
            ...
            if (unityVersion.StartsWith("2019.4") || unityVersion.StartsWith("2019.3") || unityVersion.StartsWith("2020.1"))
            {
                ...
                if (listRequest.Status == StatusCode.Success)
                {
                    foreach (var package in listRequest.Result)
                    {
                        if (package.name == "com.unity.render-pipelines.universal")
                        {
                            ...
                            || version.StartsWith("7.1.7") || version.StartsWith("7.1.8") || version.StartsWith("7.2") || version.StartsWith("7.3") || version.StartsWith("7.4") || version.StartsWith("7.5") || version.StartsWith("7.6"))
                            {
